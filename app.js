/* ==========================================================================
   M-CRIMINOLOGIA - ESTRUTURA DE DADOS E LÓGICA DO SISTEMA
   ========================================================================== */

// --------------------------------------------------------------------------
// ÁREA RESERVADA PARA MÓDULOS (BANCO DE DADOS LOCAL)
// --------------------------------------------------------------------------
        ...
        questoes: [
          {
            ...
            opcoes: [
              "O crime, o criminoso, a pena e o tribunal.",
          ...
          },
          {
            ...
            opcoes: [
              "Hereditário e biologically determinado.",
          ...
          },
          {
            id: 13,
            pergunta:
              "A Teoria do Etiquetagem (Labeling Approach) foca-se essencialmente:",
            opcoes: [
            ...
            respostaCorreta: 1,
            dica: "Anasia o impacto do rótulo atribuído pelo sistema de justiça.",
            justificativa:
      ...
      // 3. HISTÓRIA DO DIREITO E DO PENSAMENTO JURÍDICO
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: ["Egípcia.", "Romana.", "Fenícia.", "Persa."],
            respostaCorreta: 1,
          ...
          },
          {
            ...
            opcoes: [
              ...
              "Valido apenas para uma determinada nação.",
            ],
            respostaCorreta: 1,
      ...
      // 4. INTRODUÇÃO AO ESTUDO DO DIREITO
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: ["Ab-rogação.", "Derrogação.", "Caducidade.", "Anulação."],
            respostaCorreta: 1,
          ...
          },
          {
            ...
            opcoes: ["Negligência.", "Dolo.", "Imprudência.", "Caso fortuito."],
            respostaCorreta: 1,
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: [
              ...
              "Obrigando o sujeito a responder a todas as perguntas sem recusa",
            ],
            respostaCorreta: 0,
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            justificativa:
              "Técnicas de neutralização são racionalizações prévias que protegem o indivíduo do auto-recriminação ao transgredir.",
          },
          {
            id: 11,
            pergunta:
          ...
          },
          {
            ...
            opcoes: [
              ...
              "Violões de normas cometidas por autoridades governamentais",
            ],
            respostaCorreta: 0,
        ...
        questoes: [
          {
            id: 1,
            pergunta:
              "Qual é o pilar fundamental do Principio da Legalidade no Direito Penal (Nullum crimen, nulla poena sine lege)?",
            opcoes: [
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            justificativa:
              "Falsa identidade puni a conduta de se fazer passar por outra pessoa (ou inventar dados falsos de si) para obter vantagem ilícita.",
          },
        ],
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: [
              ...
              "A consolidação do modelo proibidora internacional e a classificação rigorosa de substâncias sob controlo",
            ...
            respostaCorreta: 1,
            dica: "Marco histórico do regime proibidora mundial.",
            justificativa:
          ...
          },
          {
            id: 4,
            pergunta:
              "O fenómeno da 'Mercandização do Tráfico' e expansão de Facções Criminosas está diretamente ligado a:",
            opcoes: [
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            justificativa:
              "A mais-valia é a parcela de trabalho não paga ao operário appropriada pelo proprietário dos meios de produção.",
          },
          {
            id: 6,
            pergunta:
          ...
          },
          {
            ...
            opcoes: [
              "Perda do controlo e do pertencimento do trabalhador sobre o processo produtivos e sobre o produto do seu trabalho",
        ...
        questoes: [
          {
            ...
            opcoes: ["Mediana", "Média Aritmética", "Moda", "Variância"],
            respostaCorreta: 1,
          ...
          },
          {
            id: 12,
            pergunta:
              "O 'Intervalo Interquartil' (IQR) é calculado pela diferença entre:",
            opcoes: [
          ...
          },
          {
            ...
            opcoes: ["Unimodal", "Bimodal", "Amodal", "Multivariado contínuo"],
            respostaCorreta: 1,
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            justificativa:
              "O coeficiente angular $b$ mede quanto a variável dependente ($Y$) altera diante da mudança de uma unidade na variável independent ($X$).",
          },
          {
            id: 6,
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            id: 14,
            pergunta:
              "Qual é a principal metas das 'Tabelas de Avaliação de Risco Estruturado' (ex.: COMPAS, LSI-R)?",
            opcoes: [
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            justificativa:
              "A perda da autoridade parental é sanção grave aplicada judicialmente em casos comprovados de abuso, negligência grave ou abandono.",
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: [
              "Ser aplicada apenas após o trânsito em julgado.",
          ...
          },
          {
            ...
            opcoes: [
              ...
              "Aumentar automaticamente a pena a ser aplicada.",
      ...
      },
      {
        ...
        questoes: [
          ...
          },
          {
            id: 13,
            pergunta:
              "A tecnologia de reconhecimento facial, aplicada à segurança pública, levanta principalmente debates relacionados com:",
            opcoes: [
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: [
              ...
              "Substitui integralmente a atuação de qualquer profissional isoladamente.",
            ],
            respostaCorreta: 0,
        ...
        questoes: [
          ...
          },
          {
            ...
            opcoes: [
              ...
              "A total incapacidade de tais organizações de gerir negócios legais.",
...
function renderizarModulos() {
  ...
  BANCO_DE_DADOS.forEach((modulo) => {
    ...
    modulo.disciplinas.forEach((disciplina) => {
      ...
      btn.innerHTML = `<span>${disciplina.nome}</span> <small style="color:var(--blue-primary)">15 Qs</small>`;
      btn.onclick = () => iniciarQuiz(modulo, disciplina);
...
function verificarResposta(indiceSelecionado) {
  ...
  // Desativar todas as opções após resposta
...
function atualizarTimer() {
  const decorrido = Math.floor((Date.now() - quizAtual.tempoInicio) / 2000);
...
function finalizarQuiz() {
  ...
  const precisao = Math.round(
    (estadoGlobal.respostasCertasTotais / totalRespostas) * 100,
  );
...
// ==========================================================================
// MÓDULO P2P (ENVIO DISPOSITIVO A DISPOSITIVO)
// ==========================================================================
class P2PTransfer {
  constructor() {
  ...
  // Criar oferta de conexão para o dispositivo B
  async criarConexao() {
    this.dataChannel = this.peerConnection.createDataChannel("transferenciaApp");
    this.configurarCanal();

    const offer = await this.peerConnection.createOffer();
    await this.peerConnection.setLocalDescription(offer);
    
    // Mostra a oferta em formato de texto/QR Code para o outro aparelho
    return JSON.stringify(this.peerConnection.localDescription);
  }

  // Receber a oferta no dispositivo B e responder
  ...
  // Lógica do canal de dados
  configurarCanal() {
    this.dataChannel.onopen = () => console.log("Conexão P2P Estabelecida!");
    this.dataChannel.onmessage = (e) => {
      const payload = JSON.parse(e.data);
      if (payload.tipo === 'SYNC_BD') {
        console.log("Banco de Dados Recebido de outro dispositivo:", payload.conteudo);
        // Atualiza a interface com os novos dados recebidos
      }
    };
  }

  // Enviar a base de dados via P2P
  enviarDados(dados) {
    if (this.dataChannel && this.dataChannel.readyState === 'open') {
      this.dataChannel.send(JSON.stringify({ tipo: 'SYNC_BD', conteudo: dados }));
    }
  }
}
// Contexto de Áudio
...
{
        id: "MODULO_CRIMINOLOGIA_MUNDIAL",
    titulo:: "Sistemas de Controlo Social",
        questoes: [
  id: "mod-5",
  "Módulo Especial: Autores da Criminologia Mundial",
  disciplinas: [
    {
      ...
      questoes: [
        {
          ...
          respostaCorreta: 1,
          dica: "Também conhecido pelo conceito do 'homem médio' (l'homme moyen) e pela análise de regularidades estatísticas no crime.",
          justificativa:
            "Quetelet foi pioneiro na chamada 'estatística moral', ao aplicar métodos estatísticos para demonstrar regularidades no comportamento criminoso associadas a fatores sociais, sazonais e demográficos.",
        },
        {
          id: 2,
          nivel: "medio",
          pergunta:
            "Hans von Hentig é reconhecido na criminologia mundial por ter desenvolvido, entre os primeiros, uma:",
          opcoes: [
            "Teoria biológica do criminoso nato.",
            "Tipologia de vítimas segundo a sua contribuição ou vulnerabilidade na dinâmica do crime.",
            "Teoria da associação diferencial.",
            "Classificação dos tipos de pena aplicáveis a menores.",
          ],
          respostaCorreta: 1,
          dica: "Um dos fundadores da Vitimologia, ao lado de Mendelsohn.",
          justificativa:
            "Von Hentig propôs uma das primeiras tipologias vitimológicas, classificando as vítimas segundo diferentes graus de vulnerabilidade e de contribuição para a situação de vitimização.",
        },
        {
          id: 3,
          nivel: "facil",
          pergunta:
            "A quem se atribui, geralmente, a criação do termo 'Vitimologia' como campo de estudo?",
          opcoes: [
            "Cesare Lombroso",
            "Benjamin Mendelsohn",
            "Edwin Sutherland",
          ...
          respostaCorreta: 1,
          dica: "Advogado romeno/israelita que propôs também uma tipologia baseada no grau de culpa da vítima.",
          justificativa:
            "Benjamin Mendelsohn é amplamente reconhecido como o autor que cunhou o termo 'Vitimologia', propondo uma tipologia de vítimas segundo o seu grau de culpabilidade na relação com o agressor.",
        },
        {
          id: 4,
          nivel: "medio",
          pergunta:
            "Albert Cohen, na sua obra sobre subculturas delinquentes, explica o comportamento de certos jovens da classe trabalhadora como resposta a:",
          opcoes: [
            "Uma frustração de estatuto (status frustration) face aos valores da classe média, que a escola valoriza.",
            "Um défice genético hereditário identificado por exames antropométricos.",
            "Uma decisão puramente racional de maximizar o lucro económico.",
            "Um processo de rotulagem exclusivamente promovido pela polícia.",
          ],
          respostaCorreta: 0,
          dica: "Pense num jovem que não consegue atingir os padrões de sucesso escolar da classe média e reage invertendo esses valores.",
          justificativa:
            "Cohen argumenta que jovens da classe trabalhadora, ao não conseguirem alcançar os padrões de sucesso da classe média (fortemente presentes na escola), desenvolvem uma 'frustração de estatuto' que os leva a criar subculturas que invertem esses valores.",
        },
        {
          id: 5,
          nivel: "dificil",
          pergunta:
            "A Teoria das Oportunidades Diferenciais, de Richard Cloward e Lloyd Ohlin, complementa a Teoria da Anomia de Merton ao sublinhar que:",
          opcoes: [
            "O acesso a meios ilegítimos (como redes criminosas) também não está igualmente disponível a todos.",
            "Apenas os meios legítimos importam para explicar o crime.",
            "A criminalidade é exclusivamente hereditária.",
            "O crime desaparece completamente em sociedades industrializadas.",
          ],
          respostaCorreta: 0,
          dica: "Nem todos os que querem seguir uma 'carreira' criminosa têm igual acesso a essa via.",
          justificativa:
            "Cloward e Ohlin sublinham que, tal como o acesso aos meios legítimos de sucesso é desigual, também o acesso aos meios ilegítimos (como redes e oportunidades criminosas organizadas) não está disponível de forma igual a todos os indivíduos.",
        },
        {
          id: 6,
          nivel: "medio",
          pergunta:
            "Marvin Wolfgang, através dos seus estudos de coorte em Filadélfia, contribuiu decisivamente para a criminologia ao demonstrar que:",
          opcoes: [
            "Uma pequena percentagem de infratores ('delinquentes crónicos') é responsável por uma parte desproporcional dos crimes cometidos pelo grupo.",
            "Todos os jovens de uma geração cometem o mesmo número de crimes.",
            "O crime violento não tem qualquer relação com a idade do agente.",
            "As estatísticas oficiais são sempre completamente fiáveis.",
          ],
          respostaCorreta: 0,
          dica: "Estudo pioneiro que acompanhou uma coorte de nascimento (birth cohort) ao longo do tempo.",
          justificativa:
            "O estudo de coorte de Wolfgang em Filadélfia revelou que um pequeno grupo de 'delinquentes crónicos' era responsável por uma parcela muito desproporcional do total de crimes cometidos por toda a coorte, uma descoberta influente para políticas de intervenção focalizada.",
        },
        {
          id: 7,
          nivel: "dificil",
          pergunta:
            "O conceito de 'vergonha reintegrativa' (reintegrative shaming), proposto pelo criminólogo australiano John Braithwaite, distingue-se da vergonha estigmatizante por:",
          opcoes: [
            "Excluir permanentemente o infrator da comunidade, sem qualquer via de retorno.",
            "Desaprovar o ato, mas manter laços de respeito e abrir caminho para a reintegração do infrator na comunidade.",
            "Ignorar completamente o dano causado à vítima.",
            "Aplicar sempre penas de prisão mais longas.",
          ],
          respostaCorreta: 1,
          dica: "A diferença está em condenar o ato sem rejeitar definitivamente a pessoa.",
          justificativa:
            "Braithwaite distingue a vergonha reintegrativa (que desaprova o ato mas mantém o respeito pela pessoa, abrindo caminho à reintegração) da vergonha estigmatizante (que rejeita e exclui permanentemente o infrator), sendo a primeira associada a menor reincidência.",
        },
        {
          id: 8,
          nivel: "dificil",
          pergunta:
            "O sociólogo norueguês Nils Christie introduziu o conceito de 'vítima ideal' para descrever:",
          opcoes: [
            "A vítima perfeitamente indemnizada pelo Estado.",
            "O perfil de vítima que mais facilmente obtém reconhecimento social e credibilidade como vítima legítima (ex.: frágil, num local respeitável, agredida por um estranho).",
            "A ausência total de qualquer vítima num crime económico.",
            "Um conceito exclusivamente jurídico sem qualquer dimensão social.",
          ],
          respostaCorreta: 1,
          dica: "Pense em quem é mais facilmente 'reconhecido' como vítima pela sociedade e pelos media.",
          justificativa:
            "Christie descreve a 'vítima ideal' como o perfil que reúne características socialmente valorizadas (fragilidade, respeitabilidade, ausência de relação prévia com o agressor) que facilitam o reconhecimento social e institucional como vítima legítima, evidenciando desigualdades no tratamento de diferentes vítimas.",
        },
        {
          id: 9,
          nivel: "facil",
          pergunta:
            "A Teoria da Atividade Rotineira (Routine Activity Theory), de Lawrence Cohen e Marcus Felson, explica a ocorrência do crime pela convergência, no tempo e no espaço, de três elementos:",
          opcoes: [
            "Um infrator motivado, um alvo adequado e a ausência de um guardião capaz.",
            "Pobreza extrema, ausência de leis e clima tropical.",
            "Alta escolaridade, emprego estável e boa saúde mental.",
            "Presença policial, iluminação pública e câmaras de vigilância.",
          ],
          respostaCorreta: 0,
          dica: "Não foca nas causas profundas do desejo de delinquir, mas nas condições que tornam o crime possível no dia a dia.",
          justificativa:
            "Esta teoria sustenta que o crime ocorre quando, num mesmo tempo e lugar, convergem um infrator motivado, um alvo (pessoa ou bem) adequado e a ausência de um guardião capaz de o impedir.",
        },
        {
          id: 10,
          nivel: "medio",
          pergunta:
            "A Teoria da Escolha Racional, desenvolvida por Derek Cornish e Ronald Clarke, parte do pressuposto de que o infrator:",
          opcoes: [
            "Age sempre de forma impulsiva e sem qualquer avaliação prévia.",
            "Avalia, de forma limitada e situacional, os custos e benefícios esperados antes de decidir cometer o delito.",
            "É totalmente incapaz de qualquer forma de raciocínio.",
            "Nunca considera o risco de ser detido.",
          ],
          respostaCorreta: 1,
          dica: "Racionalidade 'limitada': o infrator não faz um cálculo perfeito, mas pondera prós e contras práticos no momento.",
          justificativa:
            "Cornish e Clarke propõem que o infrator toma decisões através de uma racionalidade limitada e situacional, ponderando esforço, risco e recompensa antes de agir — fundamento teórico central da prevenção situacional do crime.",
        },
        {
          id: 11,
          nivel: "dificil",
          pergunta:
            "A Teoria Geral da Tensão (General Strain Theory), de Robert Agnew, amplia a Teoria da Anomia de Merton ao incluir, como fonte de tensão, também:",
          opcoes: [
            "Exclusivamente a incapacidade de atingir metas económicas de sucesso.",
            "Experiências negativas como a perda de estímulos valorizados e a exposição a estímulos nocivos (ex.: abuso, perda de um ente querido).",
            "Apenas fatores biológicos hereditários.",
            "A ausência total de qualquer emoção negativa.",
          ],
          respostaCorreta: 1,
          dica: "Vai além do 'não conseguir o sucesso financeiro': inclui outras fontes de tensão emocional na vida da pessoa.",
          justificativa:
            "Agnew amplia a noção de tensão (strain) para incluir não apenas o bloqueio de metas, mas também a perda de estímulos positivos e a exposição a estímulos negativos, gerando emoções como a ira, que podem conduzir ao comportamento delinquente.",
        },
        {
          id: 12,
          nivel: "dificil",
          pergunta:
            "A Teoria Geral do Crime, de Michael Gottfredson e Travis Hirschi, atribui a principal causa do comportamento criminoso a:",
          opcoes: [
            "Um baixo autocontrolo, formado precocemente na infância e relativamente estável ao longo da vida.",
            "Uma associação exclusivamente aprendida em grupos criminosos organizados.",
            "Uma etiqueta social imposta pelo sistema de justiça.",
            "Fatores exclusivamente económicos da fase adulta.",
          ],
          respostaCorreta: 0,
          dica: "Não confundir com a Teoria do Controlo Social de Hirschi de 1969 — esta é uma teoria posterior, dos anos 1990, centrada num traço individual estável.",
          justificativa:
            "Gottfredson e Hirschi defendem que o baixo autocontrolo, desenvolvido nos primeiros anos de vida através da socialização parental, é o principal fator explicativo do comportamento criminoso e de outras condutas de risco ao longo da vida.",
        },
        {
          id: 13,
          nivel: "dificil",
          pergunta:
            "Jack Katz, na obra 'Seductions of Crime', propõe uma leitura da criminalidade centrada, principalmente, em:",
          opcoes: [
            "Fatores estruturais e económicos, ignorando qualquer dimensão emocional.",
            "As dimensões emocionais e sedutoras vividas pelo próprio infrator durante a prática do crime (ex.: excitação, exaltação moral).",
            "A herança genética do comportamento agressivo.",
            "A ausência de qualquer significado subjetivo no ato criminoso.",
          ],
          respostaCorreta: 1,
          dica: "Foca-se em como o crime pode ser vivido pelo próprio agente como algo emocionalmente atrativo, e não só como resultado de privação material.",
          justificativa:
            "Katz desloca o foco das explicações estruturais para as dimensões emocionais e simbólicas vividas pelo infrator no momento do ato, argumentando que o crime pode ser experienciado como sedutor, excitante ou moralmente significativo para quem o pratica.",
        },
        {
          id: 14,
          nivel: "medio",
          pergunta:
            "A Teoria da Contenção (Containment Theory), de Walter Reckless, explica a conformidade social através de:",
          opcoes: [
            "Uma contenção exclusivamente externa, exercida pela polícia.",
            "A combinação de uma contenção interna (autoconceito, autocontrolo) e uma contenção externa (família, comunidade) que 'contêm' o indivíduo dentro dos limites sociais.",
            "A ausência total de qualquer forma de controlo social.",
            "Um processo puramente biológico sem qualquer componente social.",
          ],
          respostaCorreta: 1,
          dica: "O nome 'contenção' já dá a pista: pensa em duas camadas, uma dentro da pessoa e outra fora, que a mantêm dentro da linha.",
          justificativa:
            "Reckless propõe que a conformidade resulta da combinação de contenções internas (como um autoconceito positivo) e contenções externas (como laços familiares e comunitários), que juntas mantêm o indivíduo afastado do comportamento desviante.",
        },
        {
          id: 15,
          nivel: "medio",
          pergunta:
            "Ronald Akers, ao desenvolver a Teoria da Aprendizagem Social, integra a Associação Diferencial de Sutherland com conceitos de:",
          opcoes: [
            "Reforço, imitação e definições cognitivas favoráveis ou desfavoráveis à conduta desviante, próprios da psicologia comportamental.",
            "Genética populacional.",
            "Cartografia urbana da Escola de Chicago.",
            "Estatística bayesiana aplicada à sentença judicial.",
          ],
          respostaCorreta: 0,
          dica: "Combina a ideia de 'aprender o crime por associação' com mecanismos de reforço comportamental.",
          justificativa:
            "Akers integra a Associação Diferencial de Sutherland com princípios da aprendizagem comportamental (reforço, imitação e definições), explicando como atitudes e comportamentos desviantes são aprendidos e mantidos através da interação social.",
        },
        {
          id: 16,
          nivel: "medio",
          pergunta:
            "David Farrington, através do 'Cambridge Study in Delinquent Development' (Reino Unido), contribuiu de forma central para consolidar:",
          opcoes: [
            "A Criminologia Desenvolvimental, através do acompanhamento longitudinal de centenas de indivíduos desde a infância.",
            "A Escola Clássica do Direito Penal.",
            "A teoria do atavismo biológico.",
            "A abolição do sistema prisional no Reino Unido.",
          ],
          respostaCorreta: 0,
          dica: "É um dos maiores e mais longos estudos longitudinais sobre delinquência já realizados.",
          justificativa:
            "O Cambridge Study, conduzido por Farrington, acompanhou centenas de homens desde a infância até à idade adulta, tornando-se um dos pilares empíricos da Criminologia Desenvolvimental e da identificação de fatores de risco e de proteção ao longo do curso de vida.",
        },
        {
          id: 17,
          nivel: "dificil",
          pergunta:
            "A Teoria da Ação Situacional (Situational Action Theory), do criminólogo sueco Per-Olof Wikström, propõe que o crime resulta da interação entre:",
          opcoes: [
            "A propensão moral do indivíduo e o contexto moral do ambiente em que a ação ocorre.",
            "Apenas fatores macroeconómicos nacionais.",
            "A cor do uniforme policial e o clima da região.",
            "A quantidade de leis penais existentes num país.",
          ],
          respostaCorreta: 0,
          dica: "É uma teoria integrativa que junta 'quem a pessoa é moralmente' com 'onde e em que contexto ela está'.",
          justificativa:
            "Wikström propõe que o comportamento criminoso resulta da interação entre a propensão moral do indivíduo (valores, autocontrolo) e o contexto moral da situação (normas do ambiente, oportunidades e provocações presentes).",
        },
        {
          id: 18,
          nivel: "facil",
          pergunta:
            "C. Ray Jeffery (criador do conceito CPTED) e Oscar Newman (autor do conceito de 'espaço defensável') têm em comum a defesa de que:",
          opcoes: [
            "O desenho e a gestão do ambiente físico podem reduzir as oportunidades para o crime.",
            "Apenas o aumento do efetivo policial reduz a criminalidade.",
            "A arquitetura urbana não tem qualquer influência sobre o comportamento humano.",
            "A prevenção do crime deve focar-se exclusivamente na reabilitação psicológica do infrator.",
          ],
          respostaCorreta: 0,
          dica: "Pense em como a forma de um edifício ou de um bairro pode facilitar ou dificultar o crime.",
          justificativa:
            "Tanto o conceito de CPTED (Crime Prevention Through Environmental Design), de Jeffery, como o de 'espaço defensável', de Newman, partem da ideia de que alterações no desenho e na gestão do ambiente físico podem reduzir as oportunidades para a prática de crimes.",
        },
        {
          id: 19,
          nivel: "medio",
          pergunta:
            "Patricia e Paul Brantingham, no âmbito da Criminologia Ambiental, desenvolveram conceitos como os 'nós' (nodes) e os 'trajetos' (paths) para explicar como:",
          opcoes: [
            "Os padrões de deslocação diária dos indivíduos (para casa, trabalho, lazer) influenciam onde e quando os crimes tendem a ocorrer.",
            "Os genes influenciam diretamente o comportamento criminoso.",
            "As leis penais são elaboradas pelos parlamentos.",
            "As penas de prisão devem ser sempre proporcionais ao dano causado.",
          ],
          respostaCorreta: 0,
          dica: "Relaciona-se com o mapa mental de deslocações que cada pessoa faz na sua rotina diária.",
          justificativa:
            "Os Brantingham demonstram, através da Criminologia Ambiental, que os padrões espaciais do crime estão associados aos 'nós' (locais frequentados) e 'trajetos' (percursos habituais) da rotina diária dos indivíduos, moldando onde e quando as oportunidades criminais surgem.",
        },
        {
          id: 20,
          nivel: "dificil",
          pergunta:
            "Sheldon e Eleanor Glueck, através do estudo longitudinal 'Unraveling Juvenile Delinquency', contribuíram para a criminologia ao:",
          opcoes: [
            "Comparar sistematicamente jovens delinquentes e não delinquentes ao longo do tempo, identificando fatores familiares e sociais associados à delinquência.",
            "Defenderem que o crime é sempre uma escolha puramente racional e calculada.",
            "Proporem a abolição total do sistema de justiça juvenil.",
